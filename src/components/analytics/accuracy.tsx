...
export default function TestAccuracyChart() {
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        const res = await fetch(`/api/accuracy?section=${selectedSection}`);
        if (!res.ok) throw new Error("Could not load accuracy data");
